...
const {getAllDeviceInfoData} = require('../../controllers/deviceInfoControllers')



const deviceInfoRouter = express.Router()




deviceInfoRouter.get('/getAllDeviceInfo',getAllDeviceInfoData)
